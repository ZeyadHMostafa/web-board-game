...
// const P1_START: u64 =   (0b0000_1000         ) | 
//                         (0b0000_0100 <<  8   ) | 
//                         (0b0000_0001 << (8*2)) | 
//                         (0b0000_0000 << (8*3)) | 
//                         (0b0000_0000 << (8*4)) | 
...
// const P2_START: u64 =   (0b0000_0011         ) | 
//                         (0b0000_0000 <<  8   ) | 
//                         (0b0000_0000 << (8*2)) | 
//                         (0b0000_0000 << (8*3)) | 
//                         (0b0000_0000 << (8*4)) | 
...
// const P1_START: u64 =   (0b1101_0000         ) |
//                         (0b1000_0100 <<  8   ) |
//                         (0b0000_0010 << (8*2)) |
//                         (0b0000_0000 << (8*3)) |
...
// const P2_START: u64 =   (0b0000_0000         ) | 
//                         (0b0000_0000 <<  8   ) | 
//                         (0b0000_0000 << (8*2)) | 
//                         (0b1000_0000 << (8*3)) | 
//                         (0b0100_0000 << (8*4)) | 
...
fn main() {
    ...
    let state = GameState::new(P2_START, P1_START, Player::P2);
    
    // Run the isolated diagnostic harness to an arbitrary depth threshold
    let target_diagnostic_ply = 6;
