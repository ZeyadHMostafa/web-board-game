    ...
    pub const fn new(luts: &'static EngineLUTs) -> Self {
        Self {
            ...
            weights: [
                ...
                // ====================================================================
                [
                    /* AllyDominates */    [[0, 0], [0, 0], [0, 0]],
                    /* EnemyDominates */   [[0, 0], [0, 0], [0, 0]],
                    /* AllyUncontested */  [[0, 0], [0, 0], [0, 0]],
                    /* EnemyUncontested */ [[0, 0], [0, 0], [0, 0]],
                    /* TiedConflict */     [[0, 0], [0, 0], [0, 0]],
                    /* NoConflict */       [[0, 0], [0, 0], [0, 0]],
                ],
                // ====================================================================
